...
export const cityCoverage = {
  perth: {
    ...
    introduction:
      'Bloomprint is building a network of independent florists across metropolitan Perth, from the coast to the eastern hills and from Joondalup to Rockingham. The suburbs below are the areas we are working to cover.',
    regions: [
      {
  ...
  sydney: {
    ...
    introduction:
      'Bloomprint is building a network of independent florists across Greater Sydney, including the CBD, eastern suburbs, Inner West, North Shore, Northern Beaches, western Sydney and the south. The suburbs below are the areas we are working to cover.',
    regions: [
      {
  ...
  melbourne: {
    ...
    state: 'Victoria',
    introduction:
      'Bloomprint is building a network of independent florists across metropolitan Melbourne, spanning the inner city, bayside, northern, eastern, south-eastern and western suburbs. The suburbs below are the areas we are working to cover.',
    regions: [
      {
  ...
  brisbane: {
    ...
    state: 'Queensland',
    introduction:
      'Bloomprint is building a network of independent florists across Greater Brisbane, including the inner city, northside, southside, bayside and western suburbs. The suburbs below are the areas we are working to cover.',
    regions: [
      {
  ...
  adelaide: {
    ...
    introduction:
      'Bloomprint is building a network of independent florists throughout metropolitan Adelaide, from the CBD and inner suburbs to the coast, Adelaide Hills, northern and southern suburbs. The suburbs below are the areas we are working to cover.',
    regions: [
      {
  ...
  hobart: {
    ...
    state: 'Tasmania',
    introduction:
      'Bloomprint is building a network of independent florists across Greater Hobart, including the central suburbs, northern corridor, Eastern Shore and Kingborough area. The suburbs below are the areas we are working to cover.',
    regions: [
      {
