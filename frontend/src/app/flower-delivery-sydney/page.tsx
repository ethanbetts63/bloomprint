...
const config: OccasionLandingPageConfig = {
  ...
  trustPoints: [
    ...
    {
      icon: MapPin,
      title: 'Designed in Sydney',
      text: 'Your order is made and delivered by an independent Sydney florist — never a warehouse. Their name on the delivery, your money in their till.',
    },
    {
      icon: ShieldCheck,
