...
import ImpactTile from '@/components/order/ImpactTile';
        ...
        pollIntervalRef.current = setInterval(async () => {
            ...
            try {
                ...
                if (order.status === 'active') {
                    ...
                    setMessage('Payment confirmed. For refunds or subscription changes, contact our support team at hello@bloomprint.com.au from the email address used at checkout.');
