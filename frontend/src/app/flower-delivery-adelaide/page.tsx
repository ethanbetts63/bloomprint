...
} from '@/components/marketing/OccasionLandingPage';
...
const config: OccasionLandingPageConfig = {
  ...
  trustPoints: [
    ...
    {
      icon: MapPin,
      title: 'Designed in Adelaide',
      text: 'Your order is made and delivered by an independent Adelaide florist — never a warehouse. Their name on the delivery, your money in their till.',
    },
    {
      icon: ShieldCheck,
