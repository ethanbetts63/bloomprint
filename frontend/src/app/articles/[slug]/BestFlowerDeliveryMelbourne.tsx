    ...
    <>
      ...
      >
        <div className="text-lg text-primary-foreground space-y-6">
          ...
          <p>If you want the florist to design around the person rather than copy a catalog image, <a href="/" className="underline hover:opacity-70">Bloomprint</a> is worth exploring. You set the occasion, budget, date, and preferences, and a local florist makes a custom bouquet from fresh available stems.</p>
        </div>
      </ArticleLayout>
      <section>
